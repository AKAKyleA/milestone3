...
?>
    ...
    <a href="services.php#lumber" class="custom-btn" style="background-image: url('images/lumberyard.jpg');">
        <div class="btn-label">Lumber Yard</div>
    </a>
    <a href="services.php#lawn" class="custom-btn" style="background-image: url('images/lawn.JPG');">
        <div class="btn-label">Lawn & Garden</div>
    </a>
    <a href="services.php#screen" class="custom-btn" style="background-image: url('images/screenrepair.jpg');">
    ...
    <div class="text-container" style="width: 40%; max-width: 500px;">
        ...
        <a href="services.php#lawn" style="display: inline-block; padding: 10px 20px; background-color: #008080; color: white; font-size: 1.2rem; text-decoration: none; border-radius: 5px;">Shop Now</a>
    </div>
</section>
...
<section class="plumbing-section" style="margin-bottom: 100px; display: flex; flex-wrap: wrap; align-items: center; justify-content: center; max-width: 1200px; margin: 0 auto;">
    <div class="text-container" style="width: 40%; max-width: 500px;">
        ...
        <a href="services.php#plumbing" style="display: inline-block; padding: 10px 20px; background-color: #008080; color: white; font-size: 1.2rem; text-decoration: none; border-radius: 5px;">Learn More</a>
    </div>
...
<section class="lumber-yard" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; max-width: 1200px; margin: 0 auto;">
    ...
    <div class="text-container" style="width: 40%; max-width: 500px;">
        ...
        <a href="services.php#lumber" style="display: inline-block; padding: 10px 20px; background-color: #008080; color: white; font-size: 1.2rem; text-decoration: none; border-radius: 5px;">Shop Now</a>
    </div>
</section>
...
<section class="services">
  <div class="service-item">
    ...
    <a href="services.php#propane" class="service-link">Learn More</a>
  </div>
  <div class="service-item">
    ...
    <a href="services.php#miscellaneous" class="service-link">Learn More</a>
  </div>
  <div class="service-item">
  ...
  <div class="service-item">
    ...
    <a href="services.php#beach" class="service-link">Learn More</a>
  </div>
</section>
